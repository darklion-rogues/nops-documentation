...
{% hint style="warning" %}
As of nOps v2, Cost Center Reports have been removed and replaced with [Collections](/using-nOps/navigating-the-nOps-ui/collections.md). See the documentation for more info.
{% endhint %}
