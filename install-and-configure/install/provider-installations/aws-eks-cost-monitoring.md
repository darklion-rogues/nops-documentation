...
To get started, you can follow these steps to deploy nOps into your Amazon EKS cluster in a few minutes using Helm.
...
## Deploying nOps on an EKS Anywhere cluster using Helm
