# nOps Cloud: Cloud Cost Explorer

{% hint style="info" %}
This documentation should only be consulted when using nOps Cloud! For information about the Cloud Cost Explorer dashboard for self-hosted nOps, see [here](/using-nOps/navigating-the-nOps-ui/cloud-costs-explorer/cloud-cost-metrics.md).
{% endhint %}
